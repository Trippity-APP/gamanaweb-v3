              ...
              <div className="space-y-8 text-gray-700">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><strong>Other Measures:</strong> We conduct due diligence on our service providers in other countries to ensure they have robust security and privacy practices. We also consider supplemental measures like encryption in transit and at rest (so that data is secure even during transfer).</li>
                  </ul>
                  <p className="leading-relaxed mt-4">
                ...
                <div className="border-t border-gray-200 pt-8 mt-12 text-center">
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Thank you for reading our Privacy Policy. We value your trust and are committed to protecting your personal data while delivering an enriching travel experience. Safe travels and happy exploring with Gamana!
                  </p>
                </div>
              </div>
            </div>
